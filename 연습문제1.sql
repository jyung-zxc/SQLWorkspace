...
SELECT EMP_NAME, SALARY * 12 "연봉", ( ( SALARY + SALARY * BONUS ) * 12 )"총수령액", ( ( SALARY + SALARY * BONUS
) * 12 ) * 0.97 "실수령액"
FROM EMPLOYEE;
...
SELECT EMP_NAME, SALARY, ( ( SALARY * 12 ) + ( SALARY * 12 * BONUS ) ) * 0.97 "실수령액", HIRE_DATE
FROM EMPLOYEE
WHERE ( ( SALARY * 12 ) + ( SALARY * 12 * BONUS ) ) * 0.97 >= 50000000;
