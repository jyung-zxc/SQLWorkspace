...
--3번
SELECT DEPARTMENT_NAME ,DEPARTMENT_NO FROM TB_DEPARTMENT;

SELECT STUDENT_NAME FROM TB_STUDENT WHERE DEPARTMENT_NO = '001' 
AND ABSENCE_YN = 'Y' AND (STUDENT_SSN LIKE '_______2%' OR STUDENT_SSN LIKE '_______4%');
...
SELECT STUDENT_ADDRESS FROM TB_STUDENT;
