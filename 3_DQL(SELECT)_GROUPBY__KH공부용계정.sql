...
--3. INTERSECT : 교집합. 여러쿼리 결과의 중복된 결과만을 조회하는 연산자
...
/*
    ...
    1. <ROLLUP>
     - ROLLUP(칼럼1, 칼럼2)
     - GROUP BY로 묶은 소그룹간의 합계와, 전체합계, 칼럼1 기준 합계를 산출할 수 있는 메서드
    
    2. <CUBE>
     - CUBE (칼럼1 ,칼럼2)
     - GROUP BY로 묶은 소그룹의 합계, 전체합계, 칼람1그룹의 합계, 칼럼2그룹의 합계를 모두 반환하는 함수
