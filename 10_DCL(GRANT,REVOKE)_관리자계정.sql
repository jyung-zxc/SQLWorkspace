...
-- 2. 계정에 CREATE SESSION 권한 부여
GRANT CREATE SESSION TO SAMPLE;

-- 3-1. SAMPLE계정에 테이블 생성권한 부여 (CREATE TABLE)
GRANT CREATE TABLE TO SAMPLE;

-- 3-2. SAMPLE 계정에 테이블 스페이스할당 (2MEGA BYTE)
--ALTER문
ALTER USER SAMPLE QUOTA 2M ON SYSTEM;

-- 4. SAMPLE 계정에 뷰를 생성할 수 있는 CREATE VIEW 권한 부여하기
...
/*
    - 객체권한
     ...
     특정객체 : TABLE, VIEW, SQUENCE
*/
-- 5. SAMPLE 계정에 KH.EMPLOYEE테이블을 조회(SELECT)할 수있는 권한 부여
...
/*
    ...
    RESOURCE : CREATE TABLE, CREATE SEQUENCE, CREATE INKEY, SELECT. ...
*/
